# monoplayer/ExitGameFromLastStair.py
...
class GameWindow:
    def __init__(self, width, height, title):
        ...
        self.image = pygame.image.load('images/dessin04.png')
    ...
    def run(self):
        while self.is_running:
            ...
            self.window_surface.blit(self.image, (255, 25))
...
if __name__ == "__main__":
    game_window = GameWindow(800, 600, "Exit game from last stair")
    game_window.run()
