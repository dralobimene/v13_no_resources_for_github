...
class Game:
    ...
    def check_collisions(self):
        ...
        if self.samc_initialisation is False:
            print("creation du samc")
        ...
        self.previous_collision_count = self.collision_count
        for monster in collisions:
            if monster not in self.previous_collisions:
                self.collision_count += 1
                print("nbre de collisions: " + str(self.collision_count))
                print("on ajoute 1 combat")
                self.samc.add_combats(
                            self.player,
                            self.liste_monsters,
                            self.menu_height_menu_combat)
    ...
    def update(self, time_delta):
        ...
        if self.liste_monsters:
            ...
            self.samc.remove_dead_monsters(
                    self.to_remove_monsters_menu_combat)
