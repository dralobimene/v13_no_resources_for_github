...
class Game:
    ...
    def check_collisions(self):
        ...
        collisions = set()  # Resetting the set for this frame
                ...
                if monster in collisions:
                    if monster.life <= 0:
                        if monster in self.liste_monsters:
                            ...
                            print("liste actualisée des monstres qui pvent attaquer le player")
                            ...
                            self.samc.remove_dead_monsters(self.to_remove_monsters_menu_combat)
                            for monster in self.liste_monsters:
                                print(monster.name)
                            
            for monster in collisions:
                if monster not in self.previous_collisions:
                    print("monstres qui peuvent attaquer le player")
